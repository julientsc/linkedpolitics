package ch.eiafr.tsc.ontology.news20min.rest;
...
import ch.eiafr.tsc.ontology.news20min.job.Job;

public class MonitorResource extends AMonitorResource {
	private static final long serialVersionUID = -1266761181066506484L;
