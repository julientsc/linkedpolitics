...
import ch.eiafr.tsc.data.news20min.driver.minutes.Search20Minuten;
import ch.eiafr.tsc.data.news20min.model.Article;
import ch.eiafr.tsc.data.news20min.tools.ParseArticle;

public class News20DEJob implements IJob{
	private static Logger logger = Logger.getLogger(News20DEJob.class);
	...
	public boolean doProcAndContinue(String param, String cacheDir) {
		...
		try {
			...
			ArrayList<URL> newsLink = Search20Minuten.search(param,
					alreadyCached);
